...
::: {.column width="58%"}
```{r, fig4, fig.align = 'center', fig.cap = "Principal results of spatial principal component analysis: (a) Eigenvalues of sPCA; (b) Map of sPCA scores of municipalities.", fig.id = TRUE}
