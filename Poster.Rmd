...
# Methods
As stated in the First Law of Geography, "Everything is related to everything else, but near things are more related than distant things" [**(Tobler, 1970)**](). Since depopulation is a variable with spatial dependence, we deal with geostatistics and machine learning techniques to carry out our purpose. Figure \@ref(fig:fig1) stands for the methodology used in this work:

```{r, fig1, out.width="40%", fig.align='center', dpi=1200, fig.cap="Methodology"}
...
1.The instrument used *par excellence* to $\color{#FFC000}{\text{detect the spatial dependence}}$ is the semivariogram [**(Montero et al., 2015)**](). Its expression is given by:
\begin{equation}
\tag{1}
...
:::
:::
```{r, fig6, fig.align='center', out.width="92%", dpi=1200, fig.cap="Depopulation Risk in municipalities of Castilla-La Mancha according to sDRI"}
