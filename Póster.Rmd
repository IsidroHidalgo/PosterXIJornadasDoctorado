...
#ESSENTIALS
title: '**Construction of a Spatial Depopulation Risk Index**'
author:
  - name: '**Isidro Hidalgo Arellano**'
    affil: 1
    main: true
    email: "Isidro.Hidalgo@uclm.es"
  - name: '**Gema Fernández-Avilés Calderón**'
    affil: 2
    main: true
    email: 'Gema.FAviles@uclm.es'
affiliation:
  - num: 1
    address: "Escuela de Ingeniería Industrial y Aeroespacial. UCLM"
  - num: 2
    address: "Facultad de CC. JJ. y SS. UCLM"
Way:
main_findings:
...
Jombart,
T.; Devillard, S.; Dufour, A.-B.; Pontier, D. *Revealing cryptic spatial patterns in genetic variability by a new
multivariate method*, Heredity, 101 (2008), 92-103.
